...
def trace_graph(inicio,final):
    ...
    pathtoEntity = homePath + '/filledTemplates/'
    print(pathtoEntity)
...
>>>>>>> 46103991be398381252bff0ffa8c8b537f9c553c
    try:
        for i in range(len(files)):
            with open(pathtoEntity+files[i]) as f:
                ...
                if "AgriFarm" in id:
                    ...
                    roads = EntityToDump["hasRoad"] #[uuid1,uuid2,uuid3]
    ...
    for key in gates_localization:
        ...
        pm =  shapely.geometry.Point((p1[1] + p2[1]) / 2, (p1[0] + p2[0]) / 2)
        gate_pm[key]=pm

    print("Gate y su punto medio:")
    print(gate_pm)
    print(gate_pm["Gate 1"])
        ...
        for key2 in gate_pm:
            if idroad_material[key1] == 'dirt':
                ...
                if dist<=0.5:
                    ...
                    G.add_edge("OpenField","Gate 2",weight=0)
...
>>>>>>> 46103991be398381252bff0ffa8c8b537f9c553c
def main():
    path = trace_graph("Building1.json","AgriParcel4.json")
    print(path.keys())
